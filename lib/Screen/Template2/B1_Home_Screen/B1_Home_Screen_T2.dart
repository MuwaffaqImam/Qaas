...
import 'package:food_template/Data_Model/breakFast.dart';
import 'package:food_template/Data_Model/dinner.dart';
import 'package:food_template/Data_Model/discoverNewPlaceHome.dart';
import 'package:food_template/Data_Model/lunch.dart';
import 'package:food_template/Screen/Template2/B1_Home_Screen/Component_Detail_Food/Food_Detail_Screen.dart';
import 'package:food_template/Screen/Template2/B3_Category_Screen/Detail_Category/Restaurant_Screen.dart';
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: new Carousel(
                        ...
                        images: [
                          NetworkImage("https://images.pexels.com/photos/1099681/pexels-photo-1099681.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"),
                          NetworkImage("https://images.pexels.com/photos/2732663/pexels-photo-2732663.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"),
                          NetworkImage("https://images.pexels.com/photos/1640770/pexels-photo-1640770.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          InkWell(
            onTap: (){
              Navigator.of(context).push(PageRouteBuilder(pageBuilder: (_,__,___)=> new restaurant(title: title,)));
            },
                      child: Material(
              child: Container(
                height: 100.0,
              ...
              child: Material(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: AssetImage(_dinner.image), fit: BoxFit.cover)),
                ),
              ),
            ),
            Padding(
